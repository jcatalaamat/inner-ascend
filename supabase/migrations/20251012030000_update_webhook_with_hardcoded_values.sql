-- Update webhook function with hardcoded URL and service role key
...
BEGIN
  ...
  PERFORM
    net.http_post(
      url := 'https://ddbuvzotcasyanocqcsh.supabase.co/functions/v1/send-report-email',
...
COMMENT ON FUNCTION notify_new_report() IS 'Sends webhook to Edge Function when new report is created (with hardcoded credentials)';
